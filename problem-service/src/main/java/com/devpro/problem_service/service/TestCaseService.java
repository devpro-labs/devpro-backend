...
public class TestCaseService {
    ...
    // CREATE
    public TestCase create(TestCaseRequest request) throws JsonProcessingException {
    ...
    // UPDATE
    public TestCase update(UUID id, TestCaseRequest request) throws JsonProcessingException {
